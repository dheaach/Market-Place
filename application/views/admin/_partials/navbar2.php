          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1 pull-right">
                    <a class="nav-link dropdown-toggle" href="#" id="keranjang" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <span class="badge badge-danger badge-counter mb-5"><?php echo $keranjang ?></span>
                    </a>
                    <!-- Dropdown - Alerts -->
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                  <a class="dropdown-item" href="<?php echo base_url('user/profile/').$nik ?>">
        ...
        <div class="normal mb-4 baris" >
            <ul class="">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-center shadow " aria-labelledby="userDropdown">
                
                <a class="dropdown-item" href="<?php echo base_url('welcome/sayur') ?>">
                  Sayur
                </a>
                <a class="dropdown-item" href="<?php echo base_url('welcome/buah') ?>">
                  Buah
                </a>
                </li>
