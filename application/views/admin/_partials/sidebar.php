<ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="<?php echo base_url('admin/transaksi'); ?>" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
       ...
       <li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'crud' ? 'active': '' ?>">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="<?php echo site_url('pembelian') ?>">Laporan Pembelian</a>
            <a class="dropdown-item" href="<?php echo site_url('langsung') ?>">Laporan Langsung</a>
            <a class="dropdown-item" href="<?php echo site_url('servis') ?>">Laporan Servis</a>
        </div>
    </li>
    </ul>
