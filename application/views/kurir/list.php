<div class="container-fluid" style="color:black;">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Barang Siap Kirim </h1>
          <!-- DataTales Example -->
                  ...
                  <tbody align="center">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url('barang/list_barang/selesai/').$data->id_beli ?>" class="btn btn-primary btn-sm"><i class="fas fa-paper-plane"></i> Terkirim</a>            
