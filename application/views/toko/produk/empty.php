        ...
        <div class="modal fade" id="modal_edit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'toko/produk/update'?>" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-4" >Kategori Barang</label>
                        <div class="col-sm-8">
                             <select name="kategori" class="form-control" required>
                              <option value="">-PILIH-</option>
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-4" >Gambar Barang</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-4" >Stok Barang</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-4" >Harga Barang</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-4" >Kondisi Barang</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-4" >Satuan Barang</label>
                        <div class="col-sm-8">
